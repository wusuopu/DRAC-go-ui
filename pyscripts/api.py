...
logfile = open('/tmp/dell-remote-access-controller.log', 'a+')
logging.basicConfig(format='%(message)s', stream=logfile, level=logging.INFO)

def set_iDRAC_script_session(idrac_ip, idrac_username, idrac_password, verify_cert='false', user_response='y'):
...
def get_current_server_power_state():
...
def set_server_power_state(power_state_value=""):
